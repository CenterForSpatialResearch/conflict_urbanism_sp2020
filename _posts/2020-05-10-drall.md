...
<div id='map'>
    ...
    <a href='#' class='active' id='1850'>1850</a>
    <a href='#' class='active' id='1910-1'>1910 1</a>
  </nav>
</div>
<script>
...
var 1850 = L.tileLayer.wms('http://maps.nypl.org/warper/layers/wms/875', {
    format: 'img/png',
    transparent: true,
    layers: 16
}).addTo(map);

var 1910-1 = L.tileLayer.wms('http://maps.nypl.org/warper/layers/wms/1057', {
    format: 'image/png',
    transparent: true,
    layers: '5'
}).addTo(map);
